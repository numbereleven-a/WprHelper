...
WPR Helper — портативная программа для целевого сбора трасс Windows Performance Recorder. Она запускает WPR непосредственно перед выбранной программой, вовремя останавливает запись и сохраняет готовый к анализу файл `.etl`.
...
2. Выберите целевую программу и при необходимости задайте аргументы.
...
6. Закройте целевую программу или нажмите **Остановить**.
